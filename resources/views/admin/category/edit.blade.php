...
@section('main_content')
	<section class="col-xl-9 account-wrapper">
						<div class="account-card">
							<form class="row" name="formEdit" id="formEdit" method="POST" action="{{Route('category.update', $category->id)}}" enctype="multipart/form-data">
								@csrf 
								@method('put') 
								...
								<div class="avatar-upload d-flex align-items-center">
									<div class=" position-relative ">
										<div class="avatar-preview thumb">
											<div id="imagePreview" style="background-image: url('{{ Storage::disk('s3')->url('uploads/category/' . $category->image) }}');"></div>
										</div>
										<div class="change-btn  thumb-edit d-flex align-items-center flex-wrap">
											<input type='file' class="form-control d-none" value="{{$category->image}}" name="image"  id="imageUpload" accept=".png, .jpg, .jpeg">
								...
								<div class="col-lg-12">
									...
									<button class="btn btn-primary mt-3 mt-sm-0" type="submit">Update Category</button>
